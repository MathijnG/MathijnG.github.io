...
import Webfusion from "../src/assets/WebfusionLogoWhite-1-300x62.png.webp";
import AIVO from "../src/assets/aivo-white.png";
                ...
                <div className="wrapper">
                    ...
                    <div className="absolute text-center w-full mt-[6rem] mb-[6rem]">
                        ...
                        <div className="flex justify-center gap-12 mt-10">
                            ...
                            <a target="_blank" href="https://github.com/MathijnG" className="social-icon">
                                <svg fill="white" viewBox="0 0 448 512"
                                     height="40px" width="40px" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a target="_blank" href="https://wa.me/31621318102" className="social-icon">
                                <svg fill="white" viewBox="0 0 448 512"
                                     height="40px" width="40px" xmlns="http://www.w3.org/2000/svg">
                                    <path
